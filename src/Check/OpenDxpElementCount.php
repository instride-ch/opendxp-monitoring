...
class OpenDxpElementCount extends AbstractCheck
{
    protected const string IDENTIFIER = 'opendxp:element_count';
    ...
    public function check(): ResultInterface
    {
        ...
        return new Success(\sprintf('There are %d OpenDXP elements in the system', $totalCount), $data);
    }

    public function getLabel(): string
    {
        return 'OpenDXP Element Count';
    }
