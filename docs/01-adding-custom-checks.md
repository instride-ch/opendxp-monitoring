...
A Check class MUST extend the [`AbstractCheck`](../src/OpenDxpMonitorBundle/Check/AbstractCheck.php)
...
> **Note:** This bundle ships with many [checks](../src/OpenDxpMonitorBundle/Check) that can serve
