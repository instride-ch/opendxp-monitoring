...
class OpenDxpUsers extends AbstractCheck
{
    protected const string IDENTIFIER = 'opendxp:users';
    ...
    public function check(): ResultInterface
    {
        ...
        return new Success(\sprintf('There are %d OpenDXP users in the system', \count($users)), $users);
    }
