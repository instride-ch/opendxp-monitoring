...
class OpenDxpAreabricks extends AbstractCheck
{
    protected const string IDENTIFIER = 'opendxp:areabricks';
    ...
    public function check(): ResultInterface
    {
        ...
        return new Success(\sprintf('There are %d Areabricks in the system', \count($bricks)), $bricks);
    }

    public function getLabel(): string
    {
        return 'OpenDXP Areabricks';
    }
}
